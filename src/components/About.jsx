    ...
    <div className="container" style={{ paddingTop: '100px' }}>
      ...
      <AnimatedSection animation="fade-up" delay={100}>
        ...
        <div className="about-content">
          ...
          <p className="about-text">
            Dr Lee conceived of this clinic at the same time as her daughter, and with the same motherly love, she brought up the clinic with her other business partners. The clinic weathered on despite the economic downturn, the SARS and H1N1 epidemics, and the COVID-19 pandemic. Dr Lee eventually acquired the clinic with her family's help and continued to nurture it with the expectations that the clinic will not cease to serve the community where it is situated. Currently, the clinic provides employment to more than 15 full or part time staff.
          </p>
        </div>
        </section>
      </AnimatedSection>
